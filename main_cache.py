...
from engine_v2flow import cache_latents
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/root/8aperMak1r/data_sub/OpenDataLab___ImageNet-1K/raw/ImageNet-1K', type=str,
                        help='dataset path')
    ...
    # caching latents
    parser.add_argument('--cached_path', default='./cache_res', help='path to cached latents')
...
def main(args):
    ...
    dataset_train = ImageFolderWithFilename(os.path.join(args.data_path, 'test_dir'), transform=transform_train)
    print(dataset_train)
